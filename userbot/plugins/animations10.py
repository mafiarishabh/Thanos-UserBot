...
async def _(event):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "__**[Good to see you Guys....]**__(github.com/thanosuser/ThanosBot)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
CmdHelp("animation110").add_command("eye", None, "Use And see").add_command(
    "thinks", None, "Use and see"
).add_command("snakes", None, "Use and see").add_command(
    "humanss", None, "Use and see"
).add_command(
    "mcss", None, "Use and see"
).add_command(
    "virusess", None, "Use and see"
).add_command(
    "rapings", None, "Use and see"
).add_command(
    "nikls", None, "Use and see"
).add_command(
    "musicss", None, "Use and see"
).add_command(
    "squeezes", None, "Use and see"
).add_command(
    "loadingss", None, "use and see"
).add_command(
    "squaress", None, "Use and see"
).add_command(
    "upss", None, "Use and see"
).add_command(
    "roundss", None, "use and see"
).add_command(
    "heartss", None, "Use And See"
).add_command(
    "animes1", None, "Use And See"
).add_command(
    "fmls1", None, "Use And See"
).add_command(
    "monkeys1", None, "Use and see"
).add_command(
    "herbers1", None, "Use and see"
).add_command(
    "hands1", None, "Use and see"
).add_command(
    "gsgs1", None, "Use and see"
).add_command(
    "unoobs1", None, "Use and see"
).add_command(
    "menoobs1", None, "Use and see"
).add_command(
    "upros1", None, "Use and see"
).add_command(
    "mepros1", None, "Use and see"
).add_command(
    "thearts", None, "Use and see"
).add_command(
    "quickheals", None, "use and see"
).add_command(
    "sqhs1", None, "Use and see"
).add_command(
    "medkit1", None, "Use and see"
).add_command(
    "macos1", None, "use and see"
).add_command(
    "window1", None, "Use And See"
).add_command(
    "linuxs1", None, "Use And See"
).add_command(
